...
pub struct UeScene {
    ...
    /// The YAML's `name`: the real circuit name, source data only.
    pub track_name: String,
    /// The YAML's `display_name`: what the game shows (the runtime catalog
    /// row takes it over `track_name`, which is often a trademark).
...
pub fn bake_all_with_dem(
    ...
    let scene = UeScene {
        ...
        track_display_name: track.display_name.clone(),
